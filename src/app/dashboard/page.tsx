...
export default function DashboardPage() {
    ...
    const tourSteps = [
        ...
        },
        {
            id: 'dashboard-price',
            title: 'هزینه شرکت',
            description: 'هزینه ورود به دوره فعلی از طریق درگاه پرداخت امن انجام می‌شود.',
        },
        {
            id: 'dashboard-cta',
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            {data.lotteryStatus === 'DRAWN' && !data.winner && hasParticipated && (
                <Alert variant="destructive">
                    <AlertDescription>قرعه‌کشی این دوره به پایان رسیده است و متأسفانه شما برنده نشدید.</AlertDescription>
                </Alert>
            )}

            {data.lotteryStatus === 'DRAWN' && !data.winner && !hasParticipated && (
                <Alert>
                    <AlertDescription>قرعه‌کشی این دوره به پایان رسیده است. شما در این دوره شرکت نکرده‌اید.</AlertDescription>
                </Alert>
            )}
                ...
                <Card data-tour-id="dashboard-status">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">
                            <StatusBadge status={data.lotteryStatus} />
                        </div>
